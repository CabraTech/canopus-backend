...
import com.cabratech.canopus.api.di.AppModuleBuilder
...
fun Application.module(testing: Boolean = false) {
	...
	startKoin { AppModuleBuilder.modules() }
	...
	routing {
		...
		post("mongo/example/test") {
			val documentAsString = call.receiveText()
			val oidOrErrorMessage = mongoDataService.saveNewDocument("col", documentAsString)
